...
const Info = () => {
  ...
  return (
    <div>
    <div className='info' style={{maxWidth: "80vw"}}>
      <Link className = 'backBtn' to='/'>{text}</Link>
      <img className="info-img" src={bubble} alt="Bubble Sort Visual" />
      <h3>Bubble Sort</h3>
      ...
      <img className="info-img" src={select} alt="Selection Sort Visual" />
      ...
      <img className="info-img" src={insert} alt="Insertion Sort Visual" />
      ...
      <img className="info-img" src={merge} alt="Merge Sort Visual" />
      <h3>Merge Sort</h3>
      ...
      <img className="info-img" src={quick} alt="Quick Sort Visual" />
      <h3>Quick Sort</h3>
      ...
      <img className='heap-img' src={heap} alt="Heap Sort Visual" />
      <h3>Heap Sort</h3>
